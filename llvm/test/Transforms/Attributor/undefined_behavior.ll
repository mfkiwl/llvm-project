...
; CHECK-NEXT:    store volatile i32 5, i32* null, align 1073741824
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    store i32 5, i32* null, align 1073741824
; CHECK-NEXT:    ret void
;
  store i32 5, i32* null
  ret void
...
; CHECK-NEXT:    call void @arg_nonnull_12(i32* nocapture nofree noundef nonnull writeonly align 4 dereferenceable(4) [[PTR]], i32* nocapture nofree noundef nonnull writeonly align 4 dereferenceable(4) [[PTR]], i32* noalias nocapture nofree noundef writeonly align 1073741824 null) #[[ATTR7]]
; CHECK-NEXT:    unreachable
; CHECK:       f:
; CHECK-NEXT:    unreachable
; CHECK:       ret:
...
; CHECK-NEXT:    call void @arg_nonnull_12_noundef_2(i32* nocapture nofree noundef nonnull writeonly align 4 dereferenceable(4) [[PTR]], i32* nocapture nofree noundef nonnull writeonly align 4 dereferenceable(4) [[PTR]], i32* noalias nocapture nofree noundef writeonly align 1073741824 null) #[[ATTR7]]
; CHECK-NEXT:    unreachable
; CHECK:       f:
; CHECK-NEXT:    unreachable
; CHECK:       ret:
