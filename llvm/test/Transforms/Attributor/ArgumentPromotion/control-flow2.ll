...
; IS________OPM-SAME: (i32* noalias nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) [[P:%.*]]) #[[ATTR0:[0-9]+]] {
; IS________OPM-NEXT:    br label [[F:%.*]]
; IS________OPM:       T:
; IS________OPM-NEXT:    unreachable
; IS________OPM:       F:
; IS________OPM-NEXT:    [[X:%.*]] = load i32, i32* [[P]], align 4
...
; IS________OPM-NEXT:    store i32 17, i32* [[A]], align 4
; IS________OPM-NEXT:    [[X:%.*]] = call i32 @callee(i32* noalias nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) [[A]]) #[[ATTR2:[0-9]+]]
; IS________OPM-NEXT:    ret i32 [[X]]
;
