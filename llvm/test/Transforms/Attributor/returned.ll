...
; CHECK-NEXT:    tail call void @unknown_fn(i32* (i32*)* noundef nonnull @calls_unknown_fn) #[[ATTR10:[0-9]+]]
; CHECK-NEXT:    ret i32* [[R]]
;
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[CALL:%.*]] = call i32* @maybe_redefined_fn(i32* [[R]]) #[[ATTR10]]
; CHECK-NEXT:    ret i32* [[R]]
;
entry:
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[CALL:%.*]] = call i32* @maybe_redefined_fn2(i32* [[R]]) #[[ATTR10]]
...
; IS__TUNIT____: attributes #[[ATTR10]] = { nounwind }
; IS__TUNIT____: attributes #[[ATTR11:[0-9]+]] = { nounwind readnone }
;.
