...
; IS________OPM: Function Attrs: noinline norecurse noreturn nounwind uwtable
; IS________OPM-LABEL: define {{[^@]+}}@call_longjmp
; IS________OPM-SAME: (i8* nocapture readnone [[TMP0:%.*]]) local_unnamed_addr #[[ATTR16:[0-9]+]] {
; IS________OPM-NEXT:    tail call void @llvm.eh.sjlj.longjmp(i8* noalias readnone [[TMP0]]) #[[ATTR5]]
; IS________OPM-NEXT:    unreachable
;
; IS________NPM: Function Attrs: noinline norecurse noreturn nounwind uwtable
; IS________NPM-LABEL: define {{[^@]+}}@call_longjmp
; IS________NPM-SAME: (i8* nocapture readnone [[TMP0:%.*]]) local_unnamed_addr #[[ATTR17:[0-9]+]] {
; IS________NPM-NEXT:    tail call void @llvm.eh.sjlj.longjmp(i8* noalias readnone [[TMP0]]) #[[ATTR5]]
; IS________NPM-NEXT:    unreachable
;
...
; IS__TUNIT_OPM: attributes #[[ATTR16]] = { noinline norecurse noreturn nounwind uwtable }
...
; IS________NPM: attributes #[[ATTR17]] = { noinline norecurse noreturn nounwind uwtable }
...
; IS__CGSCC_OPM: attributes #[[ATTR16]] = { noinline norecurse noreturn nounwind uwtable }
