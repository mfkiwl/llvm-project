...
;; void unknown(void);
;; void spmd_amenable(void) __attribute__((assume("omp_spmd_amenable")))
;;
...
attributes #4 = { "llvm.assume"="omp_spmd_amenable" }
...
; CHECK: attributes #[[ATTR3:[0-9]+]] = { "llvm.assume"="omp_spmd_amenable" }
