...
; CHECK: remark: llvm/test/Transforms/OpenMP/spmdization_remarks.c:13:5: Kernel will be executed in generic-mode due to this potential side-effect, consider to add `__attribute__((assume("omp_spmd_amenable"))` to the called function 'unknown'.
; CHECK: remark: llvm/test/Transforms/OpenMP/spmdization_remarks.c:15:5: Kernel will be executed in generic-mode due to this potential side-effect, consider to add `__attribute__((assume("omp_spmd_amenable"))` to the called function 'unknown'.
...
attributes #7 = { "llvm.assume"="omp_spmd_amenable" }
