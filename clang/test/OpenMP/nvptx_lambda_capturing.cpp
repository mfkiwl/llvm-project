...
// CHECK2-NEXT:    [[CALL:%.*]] = call i32 @_ZZN1S3fooEvENKUlvE_clEv(%class.anon* nonnull align 8 dereferenceable(8) [[TMP8]]) #[[ATTR7:[0-9]+]]
...
// CHECK2-NEXT:    [[TMP7:%.*]] = bitcast %struct.anon* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK2-NEXT:    [[TMP8:%.*]] = call i8* @__kmpc_alloc_shared(i64 16)
// CHECK2-NEXT:    [[TMP9:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP7]], i8* [[TMP8]])
// CHECK2-NEXT:    [[TMP10:%.*]] = load [[STRUCT_ANON]], %struct.anon* [[OMP_OUTLINED_ARG_AGG_]], align 8
// CHECK2-NEXT:    [[TMP11:%.*]] = bitcast i8* [[TMP9]] to %struct.anon*
// CHECK2-NEXT:    store [[STRUCT_ANON]] [[TMP10]], %struct.anon* [[TMP11]], align 8
// CHECK2-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB2]], i32 [[TMP3]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon*)* @__omp_outlined__ to i8*), i8* null, i8* [[TMP9]])
...
// CHECK2-NEXT:    [[CALL:%.*]] = call i32 @_ZZN1S3fooEvENKUlvE_clEv(%class.anon* nonnull align 8 dereferenceable(8) [[TMP10]]) #[[ATTR7]]
// CHECK2-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    [[CALL:%.*]] = call i64 @"_ZZ4mainENK3$_0clEv"(%class.anon.0* nonnull align 8 dereferenceable(40) [[TMP20]]) #[[ATTR7]]
// CHECK2-NEXT:    call void @__kmpc_target_deinit(%struct.ident_t* @[[GLOB1]], i8 1, i1 true)
// CHECK2-NEXT:    ret void
// CHECK2:       worker.exit:
// CHECK2-NEXT:    ret void
...
// CHECK2-NEXT:    [[DOTTMP_OUTLINED_AGG_ARG:%.*]] = alloca [[STRUCT_ANON_1]], align 8
...
// CHECK2-NEXT:    [[TMP17:%.*]] = bitcast %struct.anon.1* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK2-NEXT:    [[TMP18:%.*]] = call i8* @__kmpc_alloc_shared(i64 48)
// CHECK2-NEXT:    [[TMP19:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP17]], i8* [[TMP18]])
// CHECK2-NEXT:    [[TMP20:%.*]] = load [[STRUCT_ANON_1]], %struct.anon.1* [[OMP_OUTLINED_ARG_AGG_]], align 8
// CHECK2-NEXT:    [[TMP21:%.*]] = bitcast i8* [[TMP19]] to %struct.anon.1*
// CHECK2-NEXT:    store [[STRUCT_ANON_1]] [[TMP20]], %struct.anon.1* [[TMP21]], align 8
// CHECK2-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB2]], i32 [[TMP6]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.1*)* @__omp_outlined__1 to i8*), i8* null, i8* [[TMP19]])
...
// CHECK2-NEXT:    [[CALL:%.*]] = call i64 @"_ZZ4mainENK3$_0clEv"(%class.anon.0* nonnull align 8 dereferenceable(40) [[TMP29]]) #[[ATTR7]]
// CHECK2-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    [[TMP5:%.*]] = bitcast %struct.anon.2* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK2-NEXT:    [[TMP6:%.*]] = call i8* @__kmpc_alloc_shared(i64 8)
// CHECK2-NEXT:    [[TMP7:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP5]], i8* [[TMP6]])
// CHECK2-NEXT:    [[TMP8:%.*]] = load [[STRUCT_ANON_2]], %struct.anon.2* [[OMP_OUTLINED_ARG_AGG_]], align 8
// CHECK2-NEXT:    [[TMP9:%.*]] = bitcast i8* [[TMP7]] to %struct.anon.2*
// CHECK2-NEXT:    store [[STRUCT_ANON_2]] [[TMP8]], %struct.anon.2* [[TMP9]], align 8
// CHECK2-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB2]], i32 [[TMP2]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.2*)* @__omp_outlined__2 to i8*), i8* null, i8* [[TMP7]])
...
// CHECK3-NEXT:    [[CALL:%.*]] = call i64 @"_ZZ4mainENK3$_0clEv"(%class.anon* nonnull align 8 dereferenceable(40) [[TMP20]]) #[[ATTR7:[0-9]+]]
...
// CHECK3-NEXT:    [[DOTTMP_OUTLINED_AGG_ARG:%.*]] = alloca [[STRUCT_ANON]], align 8
...
// CHECK3-NEXT:    [[TMP17:%.*]] = bitcast %struct.anon* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK3-NEXT:    [[TMP18:%.*]] = call i8* @__kmpc_alloc_shared(i64 48)
// CHECK3-NEXT:    [[TMP19:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP17]], i8* [[TMP18]])
// CHECK3-NEXT:    [[TMP20:%.*]] = load [[STRUCT_ANON]], %struct.anon* [[OMP_OUTLINED_ARG_AGG_]], align 8
// CHECK3-NEXT:    [[TMP21:%.*]] = bitcast i8* [[TMP19]] to %struct.anon*
// CHECK3-NEXT:    store [[STRUCT_ANON]] [[TMP20]], %struct.anon* [[TMP21]], align 8
// CHECK3-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB2]], i32 [[TMP6]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon*)* @__omp_outlined__ to i8*), i8* null, i8* [[TMP19]])
...
// CHECK3-NEXT:    [[CALL:%.*]] = call i64 @"_ZZ4mainENK3$_0clEv"(%class.anon* nonnull align 8 dereferenceable(40) [[TMP29]]) #[[ATTR7]]
// CHECK3-NEXT:    ret void
//
//
...
// CHECK3-NEXT:    [[CALL:%.*]] = call i32 @_ZZN1S3fooEvENKUlvE_clEv(%class.anon.0* nonnull align 8 dereferenceable(8) [[TMP8]]) #[[ATTR7]]
// CHECK3-NEXT:    call void @__kmpc_target_deinit(%struct.ident_t* @[[GLOB1]], i8 1, i1 true)
// CHECK3-NEXT:    ret void
// CHECK3:       worker.exit:
// CHECK3-NEXT:    ret void
...
// CHECK3-NEXT:    [[DOTTMP_OUTLINED_AGG_ARG:%.*]] = alloca [[STRUCT_ANON_1]], align 8
// CHECK3-NEXT:    store %struct.S* [[THIS]], %struct.S** [[THIS_ADDR]], align 8
// CHECK3-NEXT:    store %class.anon.0* [[L]], %class.anon.0** [[L_ADDR]], align 8
// CHECK3-NEXT:    [[TMP0:%.*]] = load %struct.S*, %struct.S** [[THIS_ADDR]], align 8
// CHECK3-NEXT:    [[TMP1:%.*]] = load %class.anon.0*, %class.anon.0** [[L_ADDR]], align 8
...
// CHECK3-NEXT:    [[TMP7:%.*]] = bitcast %struct.anon.1* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK3-NEXT:    [[TMP8:%.*]] = call i8* @__kmpc_alloc_shared(i64 16)
// CHECK3-NEXT:    [[TMP9:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP7]], i8* [[TMP8]])
// CHECK3-NEXT:    [[TMP10:%.*]] = load [[STRUCT_ANON_1]], %struct.anon.1* [[OMP_OUTLINED_ARG_AGG_]], align 8
// CHECK3-NEXT:    [[TMP11:%.*]] = bitcast i8* [[TMP9]] to %struct.anon.1*
// CHECK3-NEXT:    store [[STRUCT_ANON_1]] [[TMP10]], %struct.anon.1* [[TMP11]], align 8
// CHECK3-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB2]], i32 [[TMP3]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.1*)* @__omp_outlined__1 to i8*), i8* null, i8* [[TMP9]])
...
// CHECK3-NEXT:    [[CALL:%.*]] = call i32 @_ZZN1S3fooEvENKUlvE_clEv(%class.anon.0* nonnull align 8 dereferenceable(8) [[TMP10]]) #[[ATTR7]]
// CHECK3-NEXT:    ret void
//
//
...
// CHECK3-NEXT:    [[TMP5:%.*]] = bitcast %struct.anon.2* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK3-NEXT:    [[TMP6:%.*]] = call i8* @__kmpc_alloc_shared(i64 8)
// CHECK3-NEXT:    [[TMP7:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP5]], i8* [[TMP6]])
// CHECK3-NEXT:    [[TMP8:%.*]] = load [[STRUCT_ANON_2]], %struct.anon.2* [[OMP_OUTLINED_ARG_AGG_]], align 8
// CHECK3-NEXT:    [[TMP9:%.*]] = bitcast i8* [[TMP7]] to %struct.anon.2*
// CHECK3-NEXT:    store [[STRUCT_ANON_2]] [[TMP8]], %struct.anon.2* [[TMP9]], align 8
// CHECK3-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB2]], i32 [[TMP2]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.2*)* @__omp_outlined__2 to i8*), i8* null, i8* [[TMP7]])
...
// CHECK4-NEXT:    [[CALL:%.*]] = call i64 @"_ZZ4mainENK3$_0clEv"(%class.anon* nonnull align 8 dereferenceable(40) [[TMP20]]) #[[ATTR7:[0-9]+]]
...
// CHECK4-NEXT:    [[DOTTMP_OUTLINED_AGG_ARG:%.*]] = alloca [[STRUCT_ANON]], align 8
...
// CHECK4-NEXT:    [[TMP17:%.*]] = bitcast %struct.anon* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK4-NEXT:    [[TMP18:%.*]] = call i8* @__kmpc_alloc_shared(i64 48)
// CHECK4-NEXT:    [[TMP19:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP17]], i8* [[TMP18]])
// CHECK4-NEXT:    [[TMP20:%.*]] = load [[STRUCT_ANON]], %struct.anon* [[OMP_OUTLINED_ARG_AGG_]], align 8
// CHECK4-NEXT:    [[TMP21:%.*]] = bitcast i8* [[TMP19]] to %struct.anon*
// CHECK4-NEXT:    store [[STRUCT_ANON]] [[TMP20]], %struct.anon* [[TMP21]], align 8
// CHECK4-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB2]], i32 [[TMP6]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon*)* @__omp_outlined__ to i8*), i8* null, i8* [[TMP19]])
...
// CHECK4-NEXT:    [[CALL:%.*]] = call i64 @"_ZZ4mainENK3$_0clEv"(%class.anon* nonnull align 8 dereferenceable(40) [[TMP29]]) #[[ATTR7]]
// CHECK4-NEXT:    ret void
//
//
...
// CHECK4-NEXT:    [[CALL:%.*]] = call i32 @_ZZN1S3fooEvENKUlvE_clEv(%class.anon.0* nonnull align 8 dereferenceable(8) [[TMP8]]) #[[ATTR7]]
// CHECK4-NEXT:    call void @__kmpc_target_deinit(%struct.ident_t* @[[GLOB1]], i8 1, i1 true)
// CHECK4-NEXT:    ret void
// CHECK4:       worker.exit:
// CHECK4-NEXT:    ret void
...
// CHECK4-NEXT:    [[DOTTMP_OUTLINED_AGG_ARG:%.*]] = alloca [[STRUCT_ANON_1]], align 8
// CHECK4-NEXT:    store %struct.S* [[THIS]], %struct.S** [[THIS_ADDR]], align 8
// CHECK4-NEXT:    store %class.anon.0* [[L]], %class.anon.0** [[L_ADDR]], align 8
// CHECK4-NEXT:    [[TMP0:%.*]] = load %struct.S*, %struct.S** [[THIS_ADDR]], align 8
// CHECK4-NEXT:    [[TMP1:%.*]] = load %class.anon.0*, %class.anon.0** [[L_ADDR]], align 8
...
// CHECK4-NEXT:    [[TMP7:%.*]] = bitcast %struct.anon.1* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK4-NEXT:    [[TMP8:%.*]] = call i8* @__kmpc_alloc_shared(i64 16)
// CHECK4-NEXT:    [[TMP9:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP7]], i8* [[TMP8]])
// CHECK4-NEXT:    [[TMP10:%.*]] = load [[STRUCT_ANON_1]], %struct.anon.1* [[OMP_OUTLINED_ARG_AGG_]], align 8
// CHECK4-NEXT:    [[TMP11:%.*]] = bitcast i8* [[TMP9]] to %struct.anon.1*
// CHECK4-NEXT:    store [[STRUCT_ANON_1]] [[TMP10]], %struct.anon.1* [[TMP11]], align 8
// CHECK4-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB2]], i32 [[TMP3]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.1*)* @__omp_outlined__1 to i8*), i8* null, i8* [[TMP9]])
...
// CHECK4-NEXT:    [[CALL:%.*]] = call i32 @_ZZN1S3fooEvENKUlvE_clEv(%class.anon.0* nonnull align 8 dereferenceable(8) [[TMP10]]) #[[ATTR7]]
// CHECK4-NEXT:    ret void
//
//
...
// CHECK4-NEXT:    [[DOTTMP_OUTLINED_AGG_ARG:%.*]] = alloca [[STRUCT_ANON_2]], align 8
...
// CHECK4-NEXT:    [[TMP5:%.*]] = bitcast %struct.anon.2* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK4-NEXT:    [[TMP6:%.*]] = call i8* @__kmpc_alloc_shared(i64 8)
// CHECK4-NEXT:    [[TMP7:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP5]], i8* [[TMP6]])
// CHECK4-NEXT:    [[TMP8:%.*]] = load [[STRUCT_ANON_2]], %struct.anon.2* [[OMP_OUTLINED_ARG_AGG_]], align 8
// CHECK4-NEXT:    [[TMP9:%.*]] = bitcast i8* [[TMP7]] to %struct.anon.2*
// CHECK4-NEXT:    store [[STRUCT_ANON_2]] [[TMP8]], %struct.anon.2* [[TMP9]], align 8
// CHECK4-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB2]], i32 [[TMP2]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.2*)* @__omp_outlined__2 to i8*), i8* null, i8* [[TMP7]])
