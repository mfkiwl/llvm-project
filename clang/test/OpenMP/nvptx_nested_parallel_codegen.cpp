...
// CHECK1-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB1]], i32 [[TMP2]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon*)* @__omp_outlined__ to i8*), i8* bitcast (void (i16, i32)* @__omp_outlined___wrapper to i8*), i8* [[TMP6]])
...
// CHECK1-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB2]], i32 [[TMP0]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.0*)* @__omp_outlined__1 to i8*), i8* bitcast (void (i16, i32)* @__omp_outlined__1_wrapper to i8*), i8* [[TMP4]])
...
// CHECK1-NEXT:    call void @_Z3usePi(i32* [[TMP2]]) #[[ATTR7]]
// CHECK1-NEXT:    ret void
//
//
...
// CHECK1-NEXT:    call void @__omp_outlined__(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon* [[TMP3]]) #[[ATTR3:[0-9]+]]
// CHECK1-NEXT:    ret void
//
//
...
// CHECK1-NEXT:    call void @_Z4workPi(i32* [[TMP3]]) #[[ATTR7]]
// CHECK1-NEXT:    ret void
//
//
...
// CHECK1-NEXT:    call void @__omp_outlined__1(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon.0* [[TMP3]]) #[[ATTR3]]
// CHECK1-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB1]], i32 [[TMP2]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon*)* @__omp_outlined__ to i8*), i8* bitcast (void (i16, i32)* @__omp_outlined___wrapper to i8*), i8* [[TMP6]])
...
// CHECK2-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB2]], i32 [[TMP0]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.0*)* @__omp_outlined__1 to i8*), i8* bitcast (void (i16, i32)* @__omp_outlined__1_wrapper to i8*), i8* [[TMP4]])
...
// CHECK2-NEXT:    call void @_Z3usePi(i32* [[TMP2]]) #[[ATTR7]]
// CHECK2-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    call void @__omp_outlined__(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon* [[TMP3]]) #[[ATTR3:[0-9]+]]
// CHECK2-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    call void @_Z4workPi(i32* [[TMP3]]) #[[ATTR7]]
// CHECK2-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    call void @__omp_outlined__1(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon.0* [[TMP3]]) #[[ATTR3]]
// CHECK2-NEXT:    ret void
//
//
...
// CHECK3-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB1]], i32 [[TMP2]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon*)* @__omp_outlined__ to i8*), i8* bitcast (void (i16, i32)* @__omp_outlined___wrapper to i8*), i8* [[TMP6]])
...
// CHECK3-NEXT:    [[TMP2:%.*]] = bitcast %struct.anon.0* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK3-NEXT:    [[TMP3:%.*]] = call i8* @__kmpc_alloc_shared(i32 4)
// CHECK3-NEXT:    [[TMP4:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP2]], i8* [[TMP3]])
// CHECK3-NEXT:    [[TMP5:%.*]] = load [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], align 4
// CHECK3-NEXT:    [[TMP6:%.*]] = bitcast i8* [[TMP4]] to %struct.anon.0*
// CHECK3-NEXT:    store [[STRUCT_ANON_0]] [[TMP5]], %struct.anon.0* [[TMP6]], align 4
// CHECK3-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB2]], i32 [[TMP0]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.0*)* @__omp_outlined__1 to i8*), i8* bitcast (void (i16, i32)* @__omp_outlined__1_wrapper to i8*), i8* [[TMP4]])
...
// CHECK3-NEXT:    call void @_Z3usePi(i32* [[TMP2]]) #[[ATTR7]]
// CHECK3-NEXT:    ret void
//
//
...
// CHECK3-NEXT:    [[TMP3:%.*]] = bitcast i8* [[TMP2]] to %struct.anon*
// CHECK3-NEXT:    call void @__omp_outlined__(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon* [[TMP3]]) #[[ATTR3:[0-9]+]]
// CHECK3-NEXT:    ret void
//
//
...
// CHECK3-NEXT:    call void @_Z4workPi(i32* [[TMP3]]) #[[ATTR7]]
// CHECK3-NEXT:    ret void
//
//
...
// CHECK3-NEXT:    call void @__omp_outlined__1(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon.0* [[TMP3]]) #[[ATTR3]]
// CHECK3-NEXT:    ret void
//
