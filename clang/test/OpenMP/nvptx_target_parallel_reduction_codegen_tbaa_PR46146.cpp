...
// CHECK1-NEXT:    call void @__omp_outlined__1(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon.0* [[TMP3]]) #[[ATTR6]]
// CHECK1-NEXT:    ret void
//
//
...
// CHECK1-NEXT:    [[TMP53:%.*]] = bitcast i8* [[TMP50]] to %"class.std::complex.2"*
// CHECK1-NEXT:    [[TMP54:%.*]] = bitcast i8* [[TMP52]] to %"class.std::complex.2"*
// CHECK1-NEXT:    [[TMP55:%.*]] = bitcast %"class.std::complex.2"* [[TMP54]] to i8*
// CHECK1-NEXT:    [[TMP56:%.*]] = bitcast %"class.std::complex.2"* [[TMP53]] to i8*
...
// CHECK1-NEXT:    call void @__omp_outlined__3(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon.3* [[TMP3]]) #[[ATTR6]]
// CHECK1-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    call void @__omp_outlined__(i32* [[DOTTHREADID_TEMP_]], i32* [[DOTZERO_ADDR]], %struct.anon* [[OMP_OUTLINED_ARG_AGG_]]) #[[ATTR6:[0-9]+]]
...
// CHECK2-NEXT:    call void @__kmpc_distribute_static_init_4(%struct.ident_t* @[[GLOB2:[0-9]+]], i32 [[TMP8]], i32 92, i32* [[DOTOMP_IS_LAST]], i32* [[DOTOMP_LB]], i32* [[DOTOMP_UB]], i32* [[DOTOMP_STRIDE]], i32 1, i32 1)
...
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP18]]) #[[ATTR6]]
...
// CHECK2-NEXT:    [[TMP24:%.*]] = bitcast %struct.anon.0* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK2-NEXT:    [[TMP25:%.*]] = call i8* @__kmpc_alloc_shared(i64 24)
// CHECK2-NEXT:    [[TMP26:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP24]], i8* [[TMP25]])
// CHECK2-NEXT:    [[TMP27:%.*]] = load [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], align 8
// CHECK2-NEXT:    [[TMP28:%.*]] = bitcast i8* [[TMP26]] to %struct.anon.0*
// CHECK2-NEXT:    store [[STRUCT_ANON_0]] [[TMP27]], %struct.anon.0* [[TMP28]], align 8
// CHECK2-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB1]], i32 [[TMP8]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.0*)* @__omp_outlined__1 to i8*), i8* bitcast (void (i16, i32)* @__omp_outlined__1_wrapper to i8*), i8* [[TMP26]])
...
// CHECK2-NEXT:    call void @__kmpc_distribute_static_fini(%struct.ident_t* @[[GLOB2]], i32 [[TMP8]])
...
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP34]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP35:%.*]] = bitcast i32* [[DOTOMP_IV]] to i8*
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP35]]) #[[ATTR6]]
...
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP7]]) #[[ATTR6]]
...
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP10]]) #[[ATTR6]]
...
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP12]]) #[[ATTR6]]
...
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP21]]) #[[ATTR6]]
...
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP24]]) #[[ATTR6]]
// CHECK2-NEXT:    store i32 0, i32* [[DOTOMP_IS_LAST]], align 4, !tbaa [[TBAA8]]
// CHECK2-NEXT:    [[TMP25:%.*]] = bitcast %"class.std::complex"* [[PARTIAL_SUM]] to i8*
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP25]]) #[[ATTR6]]
...
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP27]]) #[[ATTR6]]
...
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP30]]) #[[ATTR6]]
...
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP44]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP45:%.*]] = bitcast float* [[REF_TMP14]] to i8*
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP45]]) #[[ATTR6]]
...
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP47]]) #[[ATTR6]]
...
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP49]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP50:%.*]] = bitcast float* [[REF_TMP14]] to i8*
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP50]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP51:%.*]] = bitcast %"class.std::complex"* [[REF_TMP13]] to i8*
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP51]]) #[[ATTR6]]
// CHECK2-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK2:       omp.body.continue:
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK2:       omp.inner.for.inc:
...
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP67]]) #[[ATTR6]]
...
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP72]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP73:%.*]] = bitcast i32* [[DOTCAPTURE_EXPR_1]] to i8*
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP73]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP74:%.*]] = bitcast i32* [[DOTCAPTURE_EXPR_]] to i8*
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP74]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP75:%.*]] = bitcast i32* [[DOTOMP_IV]] to i8*
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP75]]) #[[ATTR6]]
// CHECK2-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    call void @__omp_outlined__1(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon.0* [[TMP3]]) #[[ATTR6]]
// CHECK2-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    call void @__omp_outlined__2(i32* [[DOTTHREADID_TEMP_]], i32* [[DOTZERO_ADDR]], %struct.anon.1* [[OMP_OUTLINED_ARG_AGG_]]) #[[ATTR6]]
// CHECK2-NEXT:    call void @__kmpc_target_deinit(%struct.ident_t* @[[GLOB1]], i8 1, i1 true)
// CHECK2-NEXT:    ret void
// CHECK2:       worker.exit:
// CHECK2-NEXT:    ret void
...
// CHECK2-NEXT:    [[TMP7:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    [[TMP8:%.*]] = load i32, i32* [[TMP7]], align 4, !tbaa [[TBAA8]]
// CHECK2-NEXT:    call void @__kmpc_distribute_static_init_4(%struct.ident_t* @[[GLOB2]], i32 [[TMP8]], i32 92, i32* [[DOTOMP_IS_LAST]], i32* [[DOTOMP_LB]], i32* [[DOTOMP_UB]], i32* [[DOTOMP_STRIDE]], i32 1, i32 1)
// CHECK2-NEXT:    [[TMP9:%.*]] = load i32, i32* [[DOTOMP_UB]], align 4, !tbaa [[TBAA8]]
// CHECK2-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP9]], 99
// CHECK2-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK2:       cond.true:
...
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP16]]) #[[ATTR6]]
...
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP18]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP19:%.*]] = load i32, i32* [[IB]], align 4, !tbaa [[TBAA8]]
// CHECK2-NEXT:    [[MUL3:%.*]] = mul nsw i32 [[TMP19]], 4
// CHECK2-NEXT:    store i32 [[MUL3]], i32* [[ISTART_ON_STACK]], align 4, !tbaa [[TBAA8]]
// CHECK2-NEXT:    [[TMP20:%.*]] = load i32, i32* [[IB]], align 4, !tbaa [[TBAA8]]
...
// CHECK2-NEXT:    [[TMP24:%.*]] = bitcast %struct.anon.3* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK2-NEXT:    [[TMP25:%.*]] = call i8* @__kmpc_alloc_shared(i64 24)
// CHECK2-NEXT:    [[TMP26:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP24]], i8* [[TMP25]])
// CHECK2-NEXT:    [[TMP27:%.*]] = load [[STRUCT_ANON_3]], %struct.anon.3* [[OMP_OUTLINED_ARG_AGG_]], align 8
// CHECK2-NEXT:    [[TMP28:%.*]] = bitcast i8* [[TMP26]] to %struct.anon.3*
// CHECK2-NEXT:    store [[STRUCT_ANON_3]] [[TMP27]], %struct.anon.3* [[TMP28]], align 8
// CHECK2-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB1]], i32 [[TMP8]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.3*)* @__omp_outlined__3 to i8*), i8* bitcast (void (i16, i32)* @__omp_outlined__3_wrapper to i8*), i8* [[TMP26]])
// CHECK2-NEXT:    call void @__kmpc_free_shared(i8* [[TMP25]], i64 24)
// CHECK2-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK2:       omp.body.continue:
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
...
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 16, i8* [[TMP25]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP26:%.*]] = bitcast double* [[REF_TMP]] to i8*
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP26]]) #[[ATTR6]]
// CHECK2-NEXT:    store double 0.000000e+00, double* [[REF_TMP]], align 8, !tbaa [[TBAA22]]
// CHECK2-NEXT:    [[TMP27:%.*]] = bitcast double* [[REF_TMP5]] to i8*
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP27]]) #[[ATTR6]]
...
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP28]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP29:%.*]] = bitcast double* [[REF_TMP]] to i8*
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP29]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP30:%.*]] = bitcast i32* [[I6]] to i8*
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP30]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP31:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    [[TMP32:%.*]] = load i32, i32* [[TMP31]], align 4, !tbaa [[TBAA8]]
...
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 16, i8* [[TMP44]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP45:%.*]] = bitcast double* [[REF_TMP14]] to i8*
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP45]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP46:%.*]] = load i32, i32* [[I6]], align 4, !tbaa [[TBAA8]]
...
// CHECK2-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP47]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP48:%.*]] = load i32, i32* [[I6]], align 4, !tbaa [[TBAA8]]
...
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP49]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP50:%.*]] = bitcast double* [[REF_TMP14]] to i8*
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP50]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP51:%.*]] = bitcast %"class.std::complex.2"* [[REF_TMP13]] to i8*
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 16, i8* [[TMP51]]) #[[ATTR6]]
// CHECK2-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK2:       omp.body.continue:
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK2:       omp.inner.for.inc:
...
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 16, i8* [[TMP67]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP68:%.*]] = bitcast i32* [[DOTOMP_IS_LAST]] to i8*
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP68]]) #[[ATTR6]]
// CHECK2-NEXT:    [[TMP69:%.*]] = bitcast i32* [[DOTOMP_STRIDE]] to i8*
// CHECK2-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP69]]) #[[ATTR6]]
...
// CHECK2-NEXT:    br label [[DOTSHUFFLE_PRE_COND]]
// CHECK2:       .shuffle.exit:
// CHECK2-NEXT:    [[TMP31:%.*]] = bitcast %"class.std::complex.2"* [[DOTOMP_REDUCTION_ELEMENT]] to i8*
...
// CHECK2-NEXT:    [[TMP53:%.*]] = bitcast i8* [[TMP50]] to %"class.std::complex.2"*
// CHECK2-NEXT:    [[TMP54:%.*]] = bitcast i8* [[TMP52]] to %"class.std::complex.2"*
// CHECK2-NEXT:    [[TMP55:%.*]] = bitcast %"class.std::complex.2"* [[TMP54]] to i8*
// CHECK2-NEXT:    [[TMP56:%.*]] = bitcast %"class.std::complex.2"* [[TMP53]] to i8*
...
// CHECK2-NEXT:    call void @__omp_outlined__3(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon.3* [[TMP3]]) #[[ATTR6]]
// CHECK2-NEXT:    ret void
//
//
...
// CHECK3-NEXT:    call void @__omp_outlined__(i32* [[DOTTHREADID_TEMP_]], i32* [[DOTZERO_ADDR]], %struct.anon* [[OMP_OUTLINED_ARG_AGG_]]) #[[ATTR6:[0-9]+]]
...
// CHECK3-NEXT:    call void @__kmpc_distribute_static_init_4(%struct.ident_t* @[[GLOB2:[0-9]+]], i32 [[TMP8]], i32 92, i32* [[DOTOMP_IS_LAST]], i32* [[DOTOMP_LB]], i32* [[DOTOMP_UB]], i32* [[DOTOMP_STRIDE]], i32 1, i32 1)
...
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP18]]) #[[ATTR6]]
...
// CHECK3-NEXT:    [[TMP24:%.*]] = bitcast %struct.anon.0* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK3-NEXT:    [[TMP25:%.*]] = call i8* @__kmpc_alloc_shared(i64 24)
// CHECK3-NEXT:    [[TMP26:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP24]], i8* [[TMP25]])
// CHECK3-NEXT:    [[TMP27:%.*]] = load [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], align 8
// CHECK3-NEXT:    [[TMP28:%.*]] = bitcast i8* [[TMP26]] to %struct.anon.0*
// CHECK3-NEXT:    store [[STRUCT_ANON_0]] [[TMP27]], %struct.anon.0* [[TMP28]], align 8
// CHECK3-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB1]], i32 [[TMP8]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.0*)* @__omp_outlined__1 to i8*), i8* bitcast (void (i16, i32)* @__omp_outlined__1_wrapper to i8*), i8* [[TMP26]])
...
// CHECK3-NEXT:    call void @__kmpc_distribute_static_fini(%struct.ident_t* @[[GLOB2]], i32 [[TMP8]])
...
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP34]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP35:%.*]] = bitcast i32* [[DOTOMP_IV]] to i8*
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP35]]) #[[ATTR6]]
...
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP7]]) #[[ATTR6]]
...
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP10]]) #[[ATTR6]]
...
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP12]]) #[[ATTR6]]
...
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP21]]) #[[ATTR6]]
...
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP24]]) #[[ATTR6]]
// CHECK3-NEXT:    store i32 0, i32* [[DOTOMP_IS_LAST]], align 4, !tbaa [[TBAA8]]
// CHECK3-NEXT:    [[TMP25:%.*]] = bitcast %"class.std::complex"* [[PARTIAL_SUM]] to i8*
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP25]]) #[[ATTR6]]
...
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP27]]) #[[ATTR6]]
...
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP30]]) #[[ATTR6]]
...
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP44]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP45:%.*]] = bitcast float* [[REF_TMP14]] to i8*
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP45]]) #[[ATTR6]]
...
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP47]]) #[[ATTR6]]
...
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP49]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP50:%.*]] = bitcast float* [[REF_TMP14]] to i8*
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP50]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP51:%.*]] = bitcast %"class.std::complex"* [[REF_TMP13]] to i8*
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP51]]) #[[ATTR6]]
// CHECK3-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK3:       omp.body.continue:
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
...
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP67]]) #[[ATTR6]]
...
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP72]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP73:%.*]] = bitcast i32* [[DOTCAPTURE_EXPR_1]] to i8*
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP73]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP74:%.*]] = bitcast i32* [[DOTCAPTURE_EXPR_]] to i8*
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP74]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP75:%.*]] = bitcast i32* [[DOTOMP_IV]] to i8*
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP75]]) #[[ATTR6]]
// CHECK3-NEXT:    ret void
//
//
...
// CHECK3-NEXT:    store i32 [[TMP1]], i32* [[DOTADDR1]], align 4, !tbaa [[TBAA8]]
// CHECK3-NEXT:    store i32 0, i32* [[DOTZERO_ADDR]], align 4
// CHECK3-NEXT:    call void @__kmpc_get_shared_variables_aggregate(i8** [[GLOBAL_ARGS]])
// CHECK3-NEXT:    [[TMP2:%.*]] = load i8*, i8** [[GLOBAL_ARGS]], align 8
// CHECK3-NEXT:    [[TMP3:%.*]] = bitcast i8* [[TMP2]] to %struct.anon.0*
// CHECK3-NEXT:    call void @__omp_outlined__1(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon.0* [[TMP3]]) #[[ATTR6]]
// CHECK3-NEXT:    ret void
//
//
...
// CHECK3-NEXT:    call void @__omp_outlined__2(i32* [[DOTTHREADID_TEMP_]], i32* [[DOTZERO_ADDR]], %struct.anon.1* [[OMP_OUTLINED_ARG_AGG_]]) #[[ATTR6]]
// CHECK3-NEXT:    call void @__kmpc_target_deinit(%struct.ident_t* @[[GLOB1]], i8 1, i1 true)
// CHECK3-NEXT:    ret void
// CHECK3:       worker.exit:
// CHECK3-NEXT:    ret void
...
// CHECK3-NEXT:    [[TMP7:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK3-NEXT:    [[TMP8:%.*]] = load i32, i32* [[TMP7]], align 4, !tbaa [[TBAA8]]
// CHECK3-NEXT:    call void @__kmpc_distribute_static_init_4(%struct.ident_t* @[[GLOB2]], i32 [[TMP8]], i32 92, i32* [[DOTOMP_IS_LAST]], i32* [[DOTOMP_LB]], i32* [[DOTOMP_UB]], i32* [[DOTOMP_STRIDE]], i32 1, i32 1)
// CHECK3-NEXT:    [[TMP9:%.*]] = load i32, i32* [[DOTOMP_UB]], align 4, !tbaa [[TBAA8]]
// CHECK3-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP9]], 99
// CHECK3-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK3:       cond.true:
...
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP16]]) #[[ATTR6]]
...
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP18]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP19:%.*]] = load i32, i32* [[IB]], align 4, !tbaa [[TBAA8]]
// CHECK3-NEXT:    [[MUL3:%.*]] = mul nsw i32 [[TMP19]], 4
// CHECK3-NEXT:    store i32 [[MUL3]], i32* [[ISTART_ON_STACK]], align 4, !tbaa [[TBAA8]]
// CHECK3-NEXT:    [[TMP20:%.*]] = load i32, i32* [[IB]], align 4, !tbaa [[TBAA8]]
...
// CHECK3-NEXT:    [[TMP24:%.*]] = bitcast %struct.anon.3* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK3-NEXT:    [[TMP25:%.*]] = call i8* @__kmpc_alloc_shared(i64 24)
// CHECK3-NEXT:    [[TMP26:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP24]], i8* [[TMP25]])
// CHECK3-NEXT:    [[TMP27:%.*]] = load [[STRUCT_ANON_3]], %struct.anon.3* [[OMP_OUTLINED_ARG_AGG_]], align 8
// CHECK3-NEXT:    [[TMP28:%.*]] = bitcast i8* [[TMP26]] to %struct.anon.3*
// CHECK3-NEXT:    store [[STRUCT_ANON_3]] [[TMP27]], %struct.anon.3* [[TMP28]], align 8
// CHECK3-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB1]], i32 [[TMP8]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.3*)* @__omp_outlined__3 to i8*), i8* bitcast (void (i16, i32)* @__omp_outlined__3_wrapper to i8*), i8* [[TMP26]])
// CHECK3-NEXT:    call void @__kmpc_free_shared(i8* [[TMP25]], i64 24)
// CHECK3-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK3:       omp.body.continue:
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
...
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 16, i8* [[TMP25]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP26:%.*]] = bitcast double* [[REF_TMP]] to i8*
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP26]]) #[[ATTR6]]
// CHECK3-NEXT:    store double 0.000000e+00, double* [[REF_TMP]], align 8, !tbaa [[TBAA22]]
// CHECK3-NEXT:    [[TMP27:%.*]] = bitcast double* [[REF_TMP5]] to i8*
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP27]]) #[[ATTR6]]
...
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP28]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP29:%.*]] = bitcast double* [[REF_TMP]] to i8*
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP29]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP30:%.*]] = bitcast i32* [[I6]] to i8*
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP30]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP31:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK3-NEXT:    [[TMP32:%.*]] = load i32, i32* [[TMP31]], align 4, !tbaa [[TBAA8]]
...
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 16, i8* [[TMP44]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP45:%.*]] = bitcast double* [[REF_TMP14]] to i8*
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP45]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP46:%.*]] = load i32, i32* [[I6]], align 4, !tbaa [[TBAA8]]
...
// CHECK3-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP47]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP48:%.*]] = load i32, i32* [[I6]], align 4, !tbaa [[TBAA8]]
...
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP49]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP50:%.*]] = bitcast double* [[REF_TMP14]] to i8*
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP50]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP51:%.*]] = bitcast %"class.std::complex.2"* [[REF_TMP13]] to i8*
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 16, i8* [[TMP51]]) #[[ATTR6]]
// CHECK3-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK3:       omp.body.continue:
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
...
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 16, i8* [[TMP67]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP68:%.*]] = bitcast i32* [[DOTOMP_IS_LAST]] to i8*
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP68]]) #[[ATTR6]]
// CHECK3-NEXT:    [[TMP69:%.*]] = bitcast i32* [[DOTOMP_STRIDE]] to i8*
// CHECK3-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP69]]) #[[ATTR6]]
...
// CHECK3-NEXT:    br label [[DOTSHUFFLE_PRE_COND]]
// CHECK3:       .shuffle.exit:
// CHECK3-NEXT:    [[TMP31:%.*]] = bitcast %"class.std::complex.2"* [[DOTOMP_REDUCTION_ELEMENT]] to i8*
...
// CHECK3-NEXT:    [[TMP53:%.*]] = bitcast i8* [[TMP50]] to %"class.std::complex.2"*
// CHECK3-NEXT:    [[TMP54:%.*]] = bitcast i8* [[TMP52]] to %"class.std::complex.2"*
// CHECK3-NEXT:    [[TMP55:%.*]] = bitcast %"class.std::complex.2"* [[TMP54]] to i8*
// CHECK3-NEXT:    [[TMP56:%.*]] = bitcast %"class.std::complex.2"* [[TMP53]] to i8*
...
// CHECK3-NEXT:    call void @__kmpc_get_shared_variables_aggregate(i8** [[GLOBAL_ARGS]])
// CHECK3-NEXT:    [[TMP2:%.*]] = load i8*, i8** [[GLOBAL_ARGS]], align 8
// CHECK3-NEXT:    [[TMP3:%.*]] = bitcast i8* [[TMP2]] to %struct.anon.3*
// CHECK3-NEXT:    call void @__omp_outlined__3(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon.3* [[TMP3]]) #[[ATTR6]]
// CHECK3-NEXT:    ret void
//
//
