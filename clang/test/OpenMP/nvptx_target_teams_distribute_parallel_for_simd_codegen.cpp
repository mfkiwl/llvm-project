...
// CHECK1-NEXT:    [[TMP35:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP33]], i8* [[TMP34]]), !llvm.access.group !12
// CHECK1-NEXT:    [[TMP36:%.*]] = load [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], align 1, !llvm.access.group !12
// CHECK1-NEXT:    [[TMP37:%.*]] = bitcast i8* [[TMP35]] to %struct.anon.0*
// CHECK1-NEXT:    store [[STRUCT_ANON_0]] [[TMP36]], %struct.anon.0* [[TMP37]], align 1, !llvm.access.group !12
// CHECK1-NEXT:    [[TMP38:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8, !llvm.access.group !12
// CHECK1-NEXT:    [[TMP39:%.*]] = load i32, i32* [[TMP38]], align 4, !llvm.access.group !12
// CHECK1-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB4]], i32 [[TMP39]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.0*)* @__omp_outlined__1 to i8*), i8* null, i8* [[TMP35]]), !llvm.access.group !12
...
// CHECK1-NEXT:    [[TMP31:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP29]], i8* [[TMP30]]), !llvm.access.group !19
// CHECK1-NEXT:    [[TMP32:%.*]] = load [[STRUCT_ANON_3]], %struct.anon.3* [[OMP_OUTLINED_ARG_AGG_]], align 8, !llvm.access.group !19
// CHECK1-NEXT:    [[TMP33:%.*]] = bitcast i8* [[TMP31]] to %struct.anon.3*
// CHECK1-NEXT:    store [[STRUCT_ANON_3]] [[TMP32]], %struct.anon.3* [[TMP33]], align 8, !llvm.access.group !19
// CHECK1-NEXT:    [[TMP34:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8, !llvm.access.group !19
// CHECK1-NEXT:    [[TMP35:%.*]] = load i32, i32* [[TMP34]], align 4, !llvm.access.group !19
// CHECK1-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB4]], i32 [[TMP35]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.3*)* @__omp_outlined__3 to i8*), i8* null, i8* [[TMP31]]), !llvm.access.group !19
...
// CHECK1-NEXT:    [[TMP20:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP18]], i8* [[TMP19]]), !llvm.access.group !25
// CHECK1-NEXT:    [[TMP21:%.*]] = load [[STRUCT_ANON_5]], %struct.anon.5* [[OMP_OUTLINED_ARG_AGG_]], align 8, !llvm.access.group !25
// CHECK1-NEXT:    [[TMP22:%.*]] = bitcast i8* [[TMP20]] to %struct.anon.5*
// CHECK1-NEXT:    store [[STRUCT_ANON_5]] [[TMP21]], %struct.anon.5* [[TMP22]], align 8, !llvm.access.group !25
// CHECK1-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB4]], i32 [[TMP4]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.5*)* @__omp_outlined__5 to i8*), i8* null, i8* [[TMP20]]), !llvm.access.group !25
...
// CHECK1-NEXT:    [[TMP24:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP22]], i8* [[TMP23]]), !llvm.access.group !31
// CHECK1-NEXT:    [[TMP25:%.*]] = load [[STRUCT_ANON_8]], %struct.anon.8* [[OMP_OUTLINED_ARG_AGG_]], align 1, !llvm.access.group !31
// CHECK1-NEXT:    [[TMP26:%.*]] = bitcast i8* [[TMP24]] to %struct.anon.8*
// CHECK1-NEXT:    store [[STRUCT_ANON_8]] [[TMP25]], %struct.anon.8* [[TMP26]], align 1, !llvm.access.group !31
// CHECK1-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB4]], i32 [[TMP6]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.8*)* @__omp_outlined__7 to i8*), i8* null, i8* [[TMP24]]), !llvm.access.group !31
...
// CHECK2-NEXT:    [[TMP33:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP31]], i8* [[TMP32]]), !llvm.access.group !12
// CHECK2-NEXT:    [[TMP34:%.*]] = load [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], align 4, !llvm.access.group !12
// CHECK2-NEXT:    [[TMP35:%.*]] = bitcast i8* [[TMP33]] to %struct.anon.0*
// CHECK2-NEXT:    store [[STRUCT_ANON_0]] [[TMP34]], %struct.anon.0* [[TMP35]], align 4, !llvm.access.group !12
// CHECK2-NEXT:    [[TMP36:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4, !llvm.access.group !12
// CHECK2-NEXT:    [[TMP37:%.*]] = load i32, i32* [[TMP36]], align 4, !llvm.access.group !12
// CHECK2-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB4]], i32 [[TMP37]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.0*)* @__omp_outlined__1 to i8*), i8* null, i8* [[TMP33]]), !llvm.access.group !12
...
// CHECK2-NEXT:    [[TMP29:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP27]], i8* [[TMP28]]), !llvm.access.group !19
// CHECK2-NEXT:    [[TMP30:%.*]] = load [[STRUCT_ANON_2]], %struct.anon.2* [[OMP_OUTLINED_ARG_AGG_]], align 4, !llvm.access.group !19
// CHECK2-NEXT:    [[TMP31:%.*]] = bitcast i8* [[TMP29]] to %struct.anon.2*
// CHECK2-NEXT:    store [[STRUCT_ANON_2]] [[TMP30]], %struct.anon.2* [[TMP31]], align 4, !llvm.access.group !19
// CHECK2-NEXT:    [[TMP32:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4, !llvm.access.group !19
// CHECK2-NEXT:    [[TMP33:%.*]] = load i32, i32* [[TMP32]], align 4, !llvm.access.group !19
// CHECK2-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB4]], i32 [[TMP33]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.2*)* @__omp_outlined__3 to i8*), i8* null, i8* [[TMP29]]), !llvm.access.group !19
...
// CHECK2-NEXT:    [[TMP18:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP16]], i8* [[TMP17]]), !llvm.access.group !25
// CHECK2-NEXT:    [[TMP19:%.*]] = load [[STRUCT_ANON_4]], %struct.anon.4* [[OMP_OUTLINED_ARG_AGG_]], align 4, !llvm.access.group !25
// CHECK2-NEXT:    [[TMP20:%.*]] = bitcast i8* [[TMP18]] to %struct.anon.4*
// CHECK2-NEXT:    store [[STRUCT_ANON_4]] [[TMP19]], %struct.anon.4* [[TMP20]], align 4, !llvm.access.group !25
// CHECK2-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB4]], i32 [[TMP4]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.4*)* @__omp_outlined__5 to i8*), i8* null, i8* [[TMP18]]), !llvm.access.group !25
...
// CHECK2-NEXT:    [[TMP22:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP20]], i8* [[TMP21]]), !llvm.access.group !31
// CHECK2-NEXT:    [[TMP23:%.*]] = load [[STRUCT_ANON_6]], %struct.anon.6* [[OMP_OUTLINED_ARG_AGG_]], align 4, !llvm.access.group !31
// CHECK2-NEXT:    [[TMP24:%.*]] = bitcast i8* [[TMP22]] to %struct.anon.6*
// CHECK2-NEXT:    store [[STRUCT_ANON_6]] [[TMP23]], %struct.anon.6* [[TMP24]], align 4, !llvm.access.group !31
// CHECK2-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB4]], i32 [[TMP6]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.6*)* @__omp_outlined__7 to i8*), i8* null, i8* [[TMP22]]), !llvm.access.group !31
...
// CHECK3-NEXT:    [[TMP33:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP31]], i8* [[TMP32]]), !llvm.access.group !12
// CHECK3-NEXT:    [[TMP34:%.*]] = load [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], align 4, !llvm.access.group !12
// CHECK3-NEXT:    [[TMP35:%.*]] = bitcast i8* [[TMP33]] to %struct.anon.0*
// CHECK3-NEXT:    store [[STRUCT_ANON_0]] [[TMP34]], %struct.anon.0* [[TMP35]], align 4, !llvm.access.group !12
// CHECK3-NEXT:    [[TMP36:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4, !llvm.access.group !12
// CHECK3-NEXT:    [[TMP37:%.*]] = load i32, i32* [[TMP36]], align 4, !llvm.access.group !12
// CHECK3-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB4]], i32 [[TMP37]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.0*)* @__omp_outlined__1 to i8*), i8* null, i8* [[TMP33]]), !llvm.access.group !12
...
// CHECK3-NEXT:    [[TMP29:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP27]], i8* [[TMP28]]), !llvm.access.group !19
// CHECK3-NEXT:    [[TMP30:%.*]] = load [[STRUCT_ANON_2]], %struct.anon.2* [[OMP_OUTLINED_ARG_AGG_]], align 4, !llvm.access.group !19
// CHECK3-NEXT:    [[TMP31:%.*]] = bitcast i8* [[TMP29]] to %struct.anon.2*
// CHECK3-NEXT:    store [[STRUCT_ANON_2]] [[TMP30]], %struct.anon.2* [[TMP31]], align 4, !llvm.access.group !19
// CHECK3-NEXT:    [[TMP32:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4, !llvm.access.group !19
// CHECK3-NEXT:    [[TMP33:%.*]] = load i32, i32* [[TMP32]], align 4, !llvm.access.group !19
// CHECK3-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB4]], i32 [[TMP33]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.2*)* @__omp_outlined__3 to i8*), i8* null, i8* [[TMP29]]), !llvm.access.group !19
...
// CHECK3-NEXT:    [[TMP18:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP16]], i8* [[TMP17]]), !llvm.access.group !25
// CHECK3-NEXT:    [[TMP19:%.*]] = load [[STRUCT_ANON_4]], %struct.anon.4* [[OMP_OUTLINED_ARG_AGG_]], align 4, !llvm.access.group !25
// CHECK3-NEXT:    [[TMP20:%.*]] = bitcast i8* [[TMP18]] to %struct.anon.4*
// CHECK3-NEXT:    store [[STRUCT_ANON_4]] [[TMP19]], %struct.anon.4* [[TMP20]], align 4, !llvm.access.group !25
// CHECK3-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB4]], i32 [[TMP4]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.4*)* @__omp_outlined__5 to i8*), i8* null, i8* [[TMP18]]), !llvm.access.group !25
...
// CHECK3-NEXT:    [[TMP22:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP20]], i8* [[TMP21]]), !llvm.access.group !31
// CHECK3-NEXT:    [[TMP23:%.*]] = load [[STRUCT_ANON_6]], %struct.anon.6* [[OMP_OUTLINED_ARG_AGG_]], align 4, !llvm.access.group !31
// CHECK3-NEXT:    [[TMP24:%.*]] = bitcast i8* [[TMP22]] to %struct.anon.6*
// CHECK3-NEXT:    store [[STRUCT_ANON_6]] [[TMP23]], %struct.anon.6* [[TMP24]], align 4, !llvm.access.group !31
// CHECK3-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB4]], i32 [[TMP6]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.6*)* @__omp_outlined__7 to i8*), i8* null, i8* [[TMP22]]), !llvm.access.group !31
