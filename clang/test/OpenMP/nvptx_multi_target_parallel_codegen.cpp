...
// CHECK3-NEXT:    [[TMP2:%.*]] = bitcast %struct.anon* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK3-NEXT:    [[TMP3:%.*]] = call i8* @__kmpc_alloc_shared(i32 1)
// CHECK3-NEXT:    [[TMP4:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP2]], i8* [[TMP3]])
// CHECK3-NEXT:    [[TMP5:%.*]] = load [[STRUCT_ANON]], %struct.anon* [[OMP_OUTLINED_ARG_AGG_]], align 1
// CHECK3-NEXT:    [[TMP6:%.*]] = bitcast i8* [[TMP4]] to %struct.anon*
// CHECK3-NEXT:    store [[STRUCT_ANON]] [[TMP5]], %struct.anon* [[TMP6]], align 1
// CHECK3-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB2]], i32 [[TMP1]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon*)* @__omp_outlined__ to i8*), i8* null, i8* [[TMP4]])
...
// CHECK3-NEXT:    [[TMP1:%.*]] = bitcast %struct.anon.0* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK3-NEXT:    [[TMP2:%.*]] = call i8* @__kmpc_alloc_shared(i32 1)
// CHECK3-NEXT:    [[TMP3:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP1]], i8* [[TMP2]])
// CHECK3-NEXT:    [[TMP4:%.*]] = load [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], align 1
// CHECK3-NEXT:    [[TMP5:%.*]] = bitcast i8* [[TMP3]] to %struct.anon.0*
// CHECK3-NEXT:    store [[STRUCT_ANON_0]] [[TMP4]], %struct.anon.0* [[TMP5]], align 1
// CHECK3-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB3]], i32 [[TMP0]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.0*)* @__omp_outlined__1 to i8*), i8* bitcast (void (i16, i32)* @__omp_outlined__1_wrapper to i8*), i8* [[TMP3]])
...
// CHECK3-NEXT:    call void @__omp_outlined__1(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon.0* null) #[[ATTR4:[0-9]+]]
// CHECK3-NEXT:    ret void
//
