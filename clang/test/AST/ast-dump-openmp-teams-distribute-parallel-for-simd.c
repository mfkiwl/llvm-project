...
// CHECK-NEXT: |       | |   `-OMPCaptureKindAttr [[ADDR_73:0x[a-z0-9]*]] <<invalid sloc>> Implicit 28
...
// CHECK-NEXT: |       | | | `-OMPCaptureKindAttr [[ADDR_166:0x[a-z0-9]*]] <<invalid sloc>> Implicit 28
// CHECK-NEXT: |       | | `-FieldDecl [[ADDR_167:0x[a-z0-9]*]] <line:14:25> col:25 implicit 'int'
// CHECK-NEXT: |       | |   `-OMPCaptureKindAttr [[ADDR_168:0x[a-z0-9]*]] <<invalid sloc>> Implicit 28
...
// CHECK-NEXT: |       | | | `-OMPCaptureKindAttr [[ADDR_265:0x[a-z0-9]*]] <<invalid sloc>> Implicit 28
// CHECK-NEXT: |       | | `-FieldDecl [[ADDR_266:0x[a-z0-9]*]] <line:22:25> col:25 implicit 'int'
// CHECK-NEXT: |       | |   `-OMPCaptureKindAttr [[ADDR_267:0x[a-z0-9]*]] <<invalid sloc>> Implicit 28
...
// CHECK-NEXT: |       | | | `-OMPCaptureKindAttr [[ADDR_379:0x[a-z0-9]*]] <<invalid sloc>> Implicit 28
// CHECK-NEXT: |       | | `-FieldDecl [[ADDR_380:0x[a-z0-9]*]] <line:30:25> col:25 implicit 'int'
// CHECK-NEXT: |       | |   `-OMPCaptureKindAttr [[ADDR_381:0x[a-z0-9]*]] <<invalid sloc>> Implicit 28
...
// CHECK-NEXT:         | | | `-OMPCaptureKindAttr [[ADDR_511:0x[a-z0-9]*]] <<invalid sloc>> Implicit 28
// CHECK-NEXT:         | | |-FieldDecl [[ADDR_512:0x[a-z0-9]*]] <line:38:25> col:25 implicit 'int'
// CHECK-NEXT:         | | | `-OMPCaptureKindAttr [[ADDR_513:0x[a-z0-9]*]] <<invalid sloc>> Implicit 28
// CHECK-NEXT:         | | `-FieldDecl [[ADDR_514:0x[a-z0-9]*]] <line:39:27> col:27 implicit 'int'
// CHECK-NEXT:         | |   `-OMPCaptureKindAttr [[ADDR_515:0x[a-z0-9]*]] <<invalid sloc>> Implicit 28
