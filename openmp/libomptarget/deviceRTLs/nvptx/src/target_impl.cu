...
EXTERN int __kmpc_get_hardware_thread_id_in_block() { return __nvvm_read_ptx_sreg_tid_x(); }
...
EXTERN unsigned GetLaneId() { return __kmpc_get_hardware_thread_id_in_block() & (WARPSIZE - 1); }
